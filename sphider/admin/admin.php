...
<?php 
	...
	function showsites($message) {
		...
		if (mysql_num_rows($result) > 0) {
			...
			?><center><b>Welcom to Sphider. <br><br>Choose "Add site" from the submenu to add a new site, or "Index" to directly go to the indexing section.</b></center><?php 
		}
		$class = "grey";
		while ($row=mysql_fetch_array($result))	{
			if ($row['indexdate']=='') {
